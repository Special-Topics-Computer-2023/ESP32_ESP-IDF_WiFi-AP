## repo
https://github.com/64030301nam/Wifi-Ap
## code
```
entry 0x40080694
...
I (160) esp_image: segment 3: paddr=00030020 vaddr=400d0020 size=6d140h (446784) map
I (322) esp_image: segment 4: paddr=0009d168 vaddr=40089c98 size=0a848h ( 43080) load
I (340) esp_image: segment 5: paddr=000a79b8 vaddr=50000000 size=00010h (    16) load
...
I (388) cpu_start: App version:      0226b90-dirty
I (394) cpu_start: Compile time:     Nov 13 2023 00:12:55
I (400) cpu_start: ELF file SHA256:  cef6da42fae27b3f...
...
W (459) spi_flash: Detected size(4096k) larger than the size in the binary image header(2048k). Using the size in the binary image header.
...
I (771) wifi:Init max length of beacon: 752/752
I (781) wifi softAP: wifi_init_softap finished. SSID:SSID-301 password:nam123456789 channel:1
```
## ผลลัพธ์จากโทรศัพท์มือถือ
![image](https://github.com/64030301nam/ESP32_ESP-IDF_WiFi-AP/assets/115066329/6f9fae03-01ad-4eb5-9928-ba0b766a8e2a)
